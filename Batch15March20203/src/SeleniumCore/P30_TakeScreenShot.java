...
/**
 * @Author -- Aditya Shinde Java + Selenium 21-Jun-2023 3:02:43 pm
 **/
public class P30_TakeScreenShot {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		// Step 2 Type cast driver to TakesScreenshot class and store it in the
		// reference variable of the same
		...
		// Step 4 Provide a path storage and place it as an args in File class object //
		// use .jpg extension as well
